  ...
  <div class="row align-items-center">
    <div class="col-md-6 mx-auto">
      <div class="card text-center" style="height: 40rem;">
        ...
        <div class="card-body">
          <h5 class="card-title my-4"><?= $filmChosen['film_title']; ?></h5>
          <p class="fs-4 text-secondary  my-3">categorie: <?= $filmChosen['categorie_name']; ?> (durée:<?= $filmChosen['film_duration']; ?>)</p>
          <p class="fs-6 fw-light  my-3"><?= $filmChosen['film_title']; ?> a été réalisé le <?= $filmChosen['film_date']; ?>
          ...
          <a href="index.php?page=add&id=<?= $_GET['id']; ?>&modify=true" class="btn btn-outline-danger text-black my-3">Modifier</a>
          <a href="http://localhost/biblioteque_films/index.php?page=list" class="btn btn-outline-primary text-black my-3"   role="button" >Retour à la liste</a>
        </div>
      </div>
        ...
        <div class="card-body">
          ...
          <div>
            <form action='' method='post'>
              ...
              <p>Classez vos films en les évaluant.</p>
                <div class="col-md-5 ">
                  
                  <label for='customRange1' class='form-label '><u></u>noter</label><span id="rangeval"> </span>
                  ...
                  <button type='submit' class='btn btn-secondary btn m-3'<?php if($filmStarsNumber['film_rank']>0){echo 'disabled';}?>>valider la note</button>
                </div>
