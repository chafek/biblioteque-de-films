...
<div class="container  <?php if(!isset($_GET['filter'])){echo "bg-dark m-3";}else{echo "bg-secondary m-3";}?>">
    <div class="row row-cols-1 justify-content-end">
            <a href="http://localhost/biblioteque_films/index.php?page=add" class="btn btn-primary btn-lg col-2 align-items-end m-2<?php if(!isset($_SESSION['email'])){echo 'disabled';}?>" tabindex="-1" role="button" aria-disabled="true">Ajouter un film</a>
    </div>
